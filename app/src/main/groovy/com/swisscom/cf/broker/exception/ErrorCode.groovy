...
enum ErrorCode {
    ...
    ATMOS_AUTHENTICATION_FAILED("69000", "ATMOS authentication failed", "SC-SB-ATMOS", HttpStatus.NETWORK_AUTHENTICATION_REQUIRED),
    ATMOS_UID_NOT_FOUND("69001", "ATMOS UID not found", "SC-SB-ATMOS", HttpStatus.INTERNAL_SERVER_ERROR),
    ATMOS_UID_ALREADY_EXISTS("69002", "ATMOS UID already exists", "SC-SB-ATMOS", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    ATMOS_CREDENTIAL_NOT_READY("69013", "ATMOS credential is not ready yet. Please try again later", "SC-SB-ATMOS-CREDENTIAL-NOT-READY", HttpStatus.SERVICE_UNAVAILABLE),
