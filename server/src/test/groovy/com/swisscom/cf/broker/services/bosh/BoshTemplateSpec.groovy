...
class BoshTemplateSpec extends Specification {
    ...
    public static final String REDIS_HA_TEMPLATE = '/bosh/sc1-redisha-bosh-template.yml'
    ...
    private String readTemplate() {
        return new File(this.getClass().getResource(REDIS_HA_TEMPLATE).getFile()).text
    }
}
