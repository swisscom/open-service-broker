...
import com.swisscom.cloud.sb.broker.provisioning.statemachine.MinimalStateMachineContext
import groovy.transform.CompileStatic

@CompileStatic
class NoOp<T extends MinimalStateMachineContext> implements OnStateChange<T> {
    @Override
