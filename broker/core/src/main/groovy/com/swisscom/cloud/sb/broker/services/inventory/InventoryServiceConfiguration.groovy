...
class InventoryServiceConfiguration {
    ...
    public InventoryService inventoryService(ServiceInstanceRepository serviceInstanceRepository,
                                             ServiceDetailRepository serviceDetailRepository) {
        return new LocalInventoryServiceImpl(serviceInstanceRepository, serviceDetailRepository)
    }
}
