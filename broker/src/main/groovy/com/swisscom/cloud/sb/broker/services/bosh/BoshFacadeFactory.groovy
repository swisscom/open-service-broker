...
class BoshFacadeFactory {
    ...
    @Autowired
    BoshFacadeFactory(BoshClientFactory boshClientFactory, BoshTemplateFactory boshTemplateFactory, TemplateConfig templateConfig) {
    ...
    BoshFacade build(BoshBasedServiceConfig boshBasedServiceConfig) {
        return new BoshFacade(boshClientFactory, boshBasedServiceConfig, boshTemplateFactory, templateConfig)
    }
}
