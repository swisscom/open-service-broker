...
class KubernetesRedisClientRedisDecorated {
    ...
    private void createTelegraf(ProvisionRequest request) {
        ...
        kubernetesTemplate.replace("TELEGRAF_IMAGE", "docker-registry.service.consul:5000\\\\/redis-telegraf-sidecar:0.0.10")
        kubernetesTemplate.replace("INFLUXDB_HOST", "inbound.hydra-177.appcloud.swisscom.com")
        kubernetesTemplate.replace("INFLUXDB_PORT", "9086")
        kubernetesTemplate.replace("INFLUXDB_USER", "admin")
