...
enum ErrorCode {
    ...
    MONGODB_OPS_MANAGER_MUTEX_FAILED("69024", "MongoDB OpsManager acquire lock failed. Please try again later", "SC-SB-MONGODB-OPSM-LOCK-FAIL", HttpStatus.SERVICE_UNAVAILABLE)
