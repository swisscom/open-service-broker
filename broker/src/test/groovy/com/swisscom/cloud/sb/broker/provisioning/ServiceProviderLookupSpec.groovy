...
class ServiceProviderLookupSpec extends Specification {
    ...
    void setup() {
        ...
        openWhiskServiceProvider = new OpenWhiskServiceProvider(new OpenWhiskConfig(), new OpenWhiskDbClient(new OpenWhiskConfig(), new RestTemplateBuilderFactory()), serviceInstanceRepository, serviceBindingRepository)
    }
